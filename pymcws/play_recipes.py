...
def play_album(media_server: MediaServer, album_artist: str, album: str,
    ...
    response = files_search(media_server, query, 'play', shuffle=shuffle, use_play_doctor=use_play_doctor, zone=zone)
...
def play_keyword(media_server: MediaServer, keyword: str, use_play_doctor: bool = False,
    ...
    response = files_search(media_server, query, 'play',  use_play_doctor=use_play_doctor, shuffle=shuffle, zone=zone)
    response.raise_for_status()
